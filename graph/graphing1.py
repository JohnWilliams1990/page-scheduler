...
def work(pageNumbers, totalPages,  FCFS, LRU, MFU, OPTIMAL):
  ...
  #print list(reversed(FCFS))
  #print list(reversed(LRU)
  #print list(reversed(MFU)
  #print list(reversed(OPTIMAL)
  ...
  p.title("Page Replacement Simulation for %d Pages" % pageNumbers )
  p.legend()
  p.show()
